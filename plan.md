...
| M12 | Network resilience + polish | 🟡 partial | IDLE reconnect-with-backoff via supervisor shipped; `grace doctor` CLI shipped; `grace oauth logout` shipped; README + SETUP.md shipped; network online/offline detection deferred |
